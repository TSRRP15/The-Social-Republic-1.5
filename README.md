...
## Конституция и правен портал

Добавена е отделна страница `constitution.html` с:

- консолидиран текст от 136 члена;
- поправки I–V и хронология;
- карта на институциите;
- правен речник;
- търсене по членове и понятия;
- директни линкове към членове;
- бутон **Печат / PDF**.

При качване в GitHub качи и файла `constitution.js`. Менюто на началната страница вече води към новия правен портал.
